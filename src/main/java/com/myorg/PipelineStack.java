...
public class PipelineStack extends Stack {
  ...
  */
  ...
  // Build & Deploy Stage
        ...
        // ----------------------------------------------------------------------
// CDK-Nag Suppressions for known safe findings
// ----------------------------------------------------------------------
NagSuppressions.addStackSuppressions(this, List.of(
    NagPackSuppression.builder()
        .id("AwsSolutions-S1")
        .reason("Artifact bucket logging not required in demo environment.")
        .build(),
    NagPackSuppression.builder()
        .id("AwsSolutions-IAM5")
        .reason("Wildcard permissions auto-generated by CDK for pipeline roles.")
        .build(),
    NagPackSuppression.builder()
        .id("AwsSolutions-CB4")
